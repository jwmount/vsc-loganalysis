...
OptionParser.new do |opts|
  ...
  opts.on("-s", "--[no-]status_file", "Write status file") do |s|
    options[:status_file] = s
  end
...
WRITE_STATUS_FILE = false              #NOTE:  will not write to output if COLLECT_UNIQUE_DOMAIN_NAMES is true
